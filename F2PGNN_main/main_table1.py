...
def train(model, BETA, SIGMA):
    ...
    overall_loss_val = []
    best_val_loss = 100
    var_name = 'disparity_{}_{}_{}_new_amazon'.format(BETA)
    ...
    var_name_2 = 'Validation_loss_{}_{}_{}_new_amazon'.format(BETA)
    var_name_3 = 'Test_RMSE_{}_{}_{}_new_amazon'.format(BETA)
    locals()[var_name] = []
...
#Provide the pre-encrypted IDs path
    ...
    for SIGMA in sigmas:
        for BETA in BETAS:
            ...
            user_neighbor_emb_new = train(model,BETA, SIGMA)
